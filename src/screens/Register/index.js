    ...
    try {
      ...
      await firestore()
        ...
        .set({
          fullName,
          email,
          photoUrl: `https://images.unsplash.com/photo-1480429370139-e0132c086e2a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8bWFufGVufDB8fDB8fHww`,
          followersCount: 0,
          followingCount: 0,
          totalPost: 0,
          createdAt: new Date(),
        ...
        <View style={[styles.container, {paddingVertical}]}>
          <View>
            ...
            <Text style={styles.caption}>
              Hi friends who love running sports, welcome to StoreRun!
            </Text>
